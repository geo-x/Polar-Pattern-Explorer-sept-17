...
let biDirectionalColor = NSColor(hue: 0.9694, saturation: 0.92, brightness: 0.95, alpha: 1.0) /* #f2133c */
...
//
let biRectHiStroke  = NSColor(hue: 0.9694, saturation: 0.92, brightness: 0.95, alpha: 1.0) /* #f2133c */
let biRectHiFill  = NSColor(hue: 0.9694, saturation: 0.92, brightness: 0.95, alpha: 1.0) /* #f2133c */
let biRectLoStroke  = NSColor(hue: 0.9694, saturation: 0.92, brightness: 0.95, alpha: 1.0) /* #f2133c */
let biRectLoFill = NSColor(hue: 0.9694, saturation: 0.92, brightness: 0.95, alpha: 0.2) /* #f2133c */
//
